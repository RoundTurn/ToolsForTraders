...
# import datasets.markdown as dm
# import datetime
...
# df = pd.read_csv(source_1, parse_dates=['Date and Time'], date_parser=dateparse)
...
layout = dbc.Container(
    ...
    #                     dbc.Tabs(
    #                         [
    #                             dbc.Tab(tab1_script, label="What are we looking at here?", style={'width': 'auto', 'height' : '425px'}),
    #                             dbc.Tab(tab2_script, label="Parameter explainer", style={'width': 'auto', 'height' : '425px'}),
    #                         ]
    #                     ),
    #                     dbc.Row([
    #                         dbc.Col([
    ...
    #                     # style={"height": "1067px", "width": "100%"})
                        ...
                        #html.Iframe(id="serviceFrameSend", src="../assets/CC_showcase.html",width="1000", height="1000")
